...
export const PROGRAMMES = {
  ...
  "Level 2 — Vocational Certificates": [
    ...
    { name: "Accounting", duration: "6 months", tuition: "$15,000", total: "$20,000", desc: "Foundation-level accounting — journal entries, ledgers, payroll, and financial record keeping aligned to NCTVET standards.", popular: true },
  ],
  "Level 3 — Diploma": [
    ...
    { name: "Accounting", duration: "8 months", tuition: "$25,000", total: "$30,000", desc: "Comprehensive accounting — financial reporting, costing, accounts receivable/payable, payroll, and supervisory accounting functions. 13 NCTVET clusters, 161 credits.", popular: true },
  ],
  "Level 4 — Associate Equivalent": [
    ...
    { name: "Training & Assessment", duration: "5 months", tuition: "$35,000", total: "$40,000", desc: "Design, deliver, and assess competency-based training programmes. Aligned to NCTVET standards for vocational trainers and assessors.", popular: true },
  ],
