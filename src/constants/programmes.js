...
export const CALC_DATA = [
  ...
  { level: "Level 2 — Vocational", name: "Accounting", tuition: 15000, goldOnly: true },
  ...
  { level: "Level 3 — Diploma", name: "Accounting", tuition: 25000, bronzeMonths: 7 },
  ...
  { level: "Level 4 — Associate Equiv.", name: "Training & Assessment", tuition: 35000, bronzeMonths: 4 },
...
export const PROGRAMME_DETAILS = {
  ...
  // ─── Level 2 — Vocational Certificates ───
  "Customer Service": { level: "Level 2 — Vocational Certificates", duration: "6 months", prerequisites: "Job Certificate, 2 CXC/CSEC subjects, or equivalent secondary school qualifications.", modules: ["Customer Service Principles & Standards", "Effective Communication in Service", "Handling Complaints & Difficult Situations", "Service Delivery in Different Channels", "Product & Service Knowledge", "Teamwork in a Service Environment", "Personal Development & Professionalism"], careers: ["Customer Service Officer", "Client Relations Associate", "Call Centre Agent", "Service Desk Attendant"] },
  "Entrepreneurship": { level: "Level 2 — Vocational Certificates", duration: "6 months", prerequisites: "Job Certificate, 2 CXC/CSEC subjects, or equivalent.", modules: ["Entrepreneurial Mindset & Opportunity Recognition", "Business Idea Development", "Basic Financial Literacy", "Marketing Your Business", "Business Registration & Compliance", "Customer Acquisition", "Record Keeping for Small Business"], careers: ["Small Business Owner", "Freelancer", "Market Vendor (Formalised)", "Sole Trader"] },
  "Administrative Assistance": { level: "Level 2 — Vocational Certificates", duration: "6 months", prerequisites: "Job Certificate, 2 CXC/CSEC subjects, or equivalent.", modules: ["Office Administration Systems", "Business Document Preparation", "Meeting & Event Coordination", "Filing & Records Management", "Telephone & Reception Skills", "Time Management & Prioritisation", "Workplace Communication"], careers: ["Administrative Assistant", "Office Clerk", "Secretary", "Personal Assistant"] },
  "Business Administration (Secretarial)": { level: "Level 2 — Vocational Certificates", duration: "6 months", prerequisites: "Job Certificate, 2 CXC/CSEC subjects, or equivalent.", modules: ["Secretarial Practices & Procedures", "Business Correspondence & Minute Taking", "Diary & Schedule Management", "Office Technology & Equipment", "Financial Record Keeping", "Professional Communication", "Organisational Skills"], careers: ["Executive Secretary", "Office Coordinator", "Administrative Officer", "Clerical Supervisor"] },
  "Industrial Security Operations": { level: "Level 2 — Vocational Certificates", duration: "6 months", prerequisites: "Job Certificate, 2 CXC/CSEC subjects, or equivalent.", modules: ["Security Industry Standards & Legislation", "Patrol & Surveillance Techniques", "Access Control Systems", "Incident Reporting & Documentation", "Emergency & Crisis Management", "Communication & Conflict De-escalation", "Health & Safety in Security"], careers: ["Licensed Security Officer", "Access Control Supervisor", "Security Patrol Officer", "Estate Security Officer"] },
  "Accounting": { level: "Level 2 — Vocational Certificates", duration: "6 months", prerequisites: "Job Certificate, 2 CXC/CSEC subjects, or equivalent.", modules: ["Process Journal Entries", "Prepare Ledger Balances & Trial Balance", "Process Customer Accounts", "Administer Accounts Payable", "Record & Account for Cash Transactions", "Maintain Daily Financial Records", "Perform Basic Payroll Transactions", "Operate Accounting Applications"], careers: ["Accounts Clerk", "Bookkeeper", "Payroll Clerk", "Accounts Payable Clerk", "Junior Accountant"] },
  // ─── Level 3 — Diploma ───
