...
export const FAQS = [
  { q: "HEART is free — why should I pay CTS ETS?", a: "HEART is an excellent institution, but they have only 3 intakes per year, mostly in-person, with fixed class schedules. CTS ETS is 100% online, self-paced, and you can start anytime. If you work full-time, live far from a HEART centre, or missed an intake — CTS ETS lets you train immediately from your phone and earn the same NCTVET qualification." },
  { q: "Do I get the same qualification as HEART students?", a: "Yes. CTS ETS trains you online. When you complete your programme, we present you to HEART/NSTA for your official NCTVET assessment — at no additional cost to you. You receive the same nationally recognised NVQ-J qualification as any classroom-trained student." },
  { q: "Is there really no classroom? No regular class days?", a: "Day-to-day studying is entirely online — no campus to visit, no fixed timetable. You study from your phone, tablet, or laptop at whatever time suits you. However, there are scheduled online class days for internal and external assessment preparation. Assessments are conducted online unless otherwise needed. We announce all assessment dates in advance so you can prepare." },
  { q: "What does 'self-paced' actually mean?", a: "It means you control when you study and how fast you move through the material. There is no pressure to keep up with a class. If you understand a topic quickly, move ahead. If something is difficult, go back and repeat it. Assessments are conducted on announced dates — we give you advance notice so you can prepare. Online class days are scheduled for assessment preparation, but your regular studying happens whenever works for you." },
  { q: "Can I study while working full-time?", a: "Absolutely — that is exactly what CTS ETS is designed for. Most of our students work full-time. They study during commutes, lunch breaks, evenings, and weekends. You never need to take time off work or rearrange your schedule." },
  { q: "What qualifications do I need to apply?", a: "Job Certificates: open entry — no prior qualifications required. Level 2: Job Certificate or 2 CXC/CSEC subjects. Level 3: Level 2 or 3 CXCs. Levels 4–5: previous level diploma." },
  { q: "Are programmes 100% online?", a: "Yes — 100% online and self-paced. You get Audio Study Sessions (listen like a podcast), an Intelligent Study Assistant (ask questions 24/7), expert-written guides, video summaries, and flashcards — all accessible from your phone." },
  { q: "How long do programmes take?", a: "2 months (Job Certificate) to 9 months (Level 5). But since you are self-paced, you can finish faster if you study more, or take longer if life gets busy. There is no penalty for going at your own speed." },
  { q: "What does my fee cover?", a: "Your fee covers the $5,000 non-refundable registration fee plus a training fee for your level. This includes full online access to all course materials, Audio Study Sessions, AI study assistant, video content, quizzes, and support. NCTVET assessment is arranged through HEART/NSTA at no additional cost." },
  { q: "What payment plans are available?", a: "Gold (pay in full, 0% surcharge) for all levels. Silver (60/40 split, +10% on training fee) and Bronze (30% deposit + monthly payments, +15% on training fee) for Levels 3–5. Surcharges apply to the training fee only, not the registration fee." },
  ...
  { q: "How do I apply?", a: "Complete the online form at ctsetsjm.com. Select Jamaican, Caribbean, or International — the form adapts for your location. You will receive your application number immediately and a confirmation email." },
  { q: "How do I contact CTS ETS?", a: "Email info@ctsetsjm.com, call or WhatsApp 876-381-9771. We respond within 24–48 hours." },
];
