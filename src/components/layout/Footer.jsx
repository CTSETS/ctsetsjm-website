...
import { NAV_LOGO, NCTVET_LOGO, HEART_LOGO, APPLY_URL, PAYMENT_URL, PORTAL_URL } from "../../constants/config";
...
export default function Footer({ setPage }) {
  var link = function(label, page) {
    return (
      <button
        key={label}
        onClick={function() { setPage(page || label); }}
        style={{
          display: "block", background: "none", border: "none",
          color: "rgba(255,255,255,0.55)", fontSize: 12,
          fontFamily: S.body, cursor: "pointer", padding: "3px 0",
  ...
  // External link helper — opens in new tab with ↗ indicator
  var extLink = function(label, url) {
    return (
      <a
        key={label}
        href={url}
        ...
        style={{
          ...
          color: "rgba(255,255,255,0.55)", fontSize: 12,
          fontFamily: S.body, padding: "3px 0",
          textAlign: "left", transition: "color 0.15s",
          textDecoration: "none",
        }}
      >
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
        ...
        >
          ...
          <div>
            ...
            <p style={{ fontSize: 11, color: "rgba(255,255,255,0.4)", fontFamily: S.body, lineHeight: 1.6, marginBottom: 8 }}>
              Jamaica's Digital Vocational School. 100% online, self-paced programmes aligned to NCTVET.
            </p>
            <p style={{ fontSize: 11, color: "rgba(255,255,255,0.3)", fontFamily: S.body, marginBottom: 4 }}>
              {"📍 6, Newark Avenue, Kingston 2 (By Appointment Only)"}
            </p>
            <p style={{ fontSize: 11, color: "rgba(255,255,255,0.3)", fontFamily: S.body, marginBottom: 4 }}>
          ...
          <div>
            ...
            <a
              ...
              rel="noopener noreferrer"
              style={{
                display: "block", color: S.emerald, fontSize: 12,
                fontFamily: S.body, padding: "3px 0",
