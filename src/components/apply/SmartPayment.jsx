  ...
  return (
    <div style={{ padding: "16px 20px", borderRadius: 10, background: S.amberLight, border: "1px solid " + S.amber + "30", marginBottom: 20 }}>
      ...
      <p style={{ fontSize: 12, color: S.gray, fontFamily: S.body, lineHeight: 1.6, margin: 0 }}>
        Pay by <strong>bank transfer</strong> (NCB — JMD or USD account) then upload your receipt below. Online card payments will be available soon. Contact <strong>admin@ctsetsjm.com</strong> or <strong>876-525-6802</strong> or WhatsApp <strong>876-381-9771</strong> for payment assistance.
      </p>
    </div>
  );
}
