...
export default function ApplyPage({ setPage }) {
  ...
  // Strict Validation Logic for Section 2
  const s2Done = s1Done 
    && form.firstName 
    && form.lastName 
    ...
    && form.address 
    && form.country 
    && (isJamaican ? (form.parish && form.trn && validateTRN(form.trn)) : true) 
    && form.employmentStatus 
    && form.emergencyName 
    && form.emergencyPhone 
    && form.emergencyRelationship 
    && form.highestQualification 
    && (!hasQualification || (form.schoolLastAttended && form.yearCompleted));
