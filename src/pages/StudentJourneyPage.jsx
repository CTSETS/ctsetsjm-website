...
const STEPS = [
  ...
  { n: 5, title: "Onboarding", icon: "🎓", color: S.teal, duration: "Same day", desc: "Receive your Learning Portal credentials. Access the CTS ETS Interactive Learning System — audio sessions, intelligent study assistant, learner guides, flashcards, and more.", actions: ["Learning Portal access granted", "Interactive Learning System activated", "Welcome email with study guide"] },
