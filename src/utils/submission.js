...
export const generateRef = () => { var d = new Date(); var yr = d.getFullYear(); var mth = String(d.getMonth() + 1).padStart(2, "0"); var num = String(Math.floor(10000 + Math.random() * 90000)); return "CTSETSA-" + yr + "-" + mth + "-" + num; };
